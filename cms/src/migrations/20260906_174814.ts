...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_site_content_people_profiles_kind" AS ENUM('mentor', 'grad');
  ...
  CREATE TABLE "site_content_how_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_content_people_profiles" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"kind" "enum_site_content_people_profiles_kind" DEFAULT 'mentor',
  	"name" varchar NOT NULL,
  	"meta" varchar,
  	"badge" varchar,
  	"bio" varchar,
  	"leaves" numeric DEFAULT 5,
  	"tys" varchar,
  	"quote" varchar,
  	"quote_from" varchar,
  	"learned" varchar,
  ...
  CREATE TABLE "site_content" (
  	...
  	"hero_headline_em" varchar,
  	"hero_subtitle" varchar NOT NULL,
  	"hero_free_sticker" varchar,
  	"hero_manifesto" varchar,
  	"how_heading" varchar NOT NULL,
  	"how_note" varchar,
  	"people_heading" varchar NOT NULL,
  	"people_lead" varchar NOT NULL,
  	"people_note" varchar,
  	"people_caption" varchar,
  	"rules_heading" varchar NOT NULL,
  	"rules_note" varchar,
  	"message_heading" varchar NOT NULL,
  	"message_sub" varchar,
  	"message_placeholder" varchar,
  	"close_heading" varchar NOT NULL,
  	"close_sub" varchar,
  	"close_note" varchar,
  	"close_store_note" varchar,
  	"match_heading" varchar,
  	"match_lead" varchar,
  	"loop_heading" varchar,
  	"loop_lead" varchar,
  ...
  ALTER TABLE "site_content_how_steps" ADD CONSTRAINT "site_content_how_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_content_people_profiles" ADD CONSTRAINT "site_content_people_profiles_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_content"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "site_content_how_steps_order_idx" ON "site_content_how_steps" USING btree ("_order");
  CREATE INDEX "site_content_how_steps_parent_id_idx" ON "site_content_how_steps" USING btree ("_parent_id");
  CREATE INDEX "site_content_people_profiles_order_idx" ON "site_content_people_profiles" USING btree ("_order");
  CREATE INDEX "site_content_people_profiles_parent_id_idx" ON "site_content_people_profiles" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_content_how_steps" CASCADE;
  DROP TABLE "site_content_people_profiles" CASCADE;
  DROP TABLE "site_content_rules_items" CASCADE;
  DROP TABLE "site_content" CASCADE;
  DROP TYPE "public"."enum_site_content_people_profiles_kind";`)
}

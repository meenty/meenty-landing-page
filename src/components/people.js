    ...
    return `
        <div class="big-card grad" aria-label="Example graduate volunteer profile">
          ...
          <div class="grad-path" aria-label="${p.name || ''} learned ${p.learned || ''} here and now teaches it">
            ...
            <svg viewBox="0 0 24 16" fill="none" aria-hidden="true"><path d="M2 8 h17 M15 3 l5 5 -5 5" style="stroke:var(--earth)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
  ...
  <section class="people">
    <div class="wrap people-grid">
      <div>
        ...
        <p class="hand" style="margin-top: 14px; font-size: 1.35rem; color: var(--earth); transform: rotate(-1deg); display: inline-block;">${people.note || ''}</p>
      </div>
      <div class="cards-col">
        ${cards}
